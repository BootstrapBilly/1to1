    ...
    return (
        ...
        <div className={classes.card} test-handle="container">
            ...
            <div className={classes.topRow} test-handle="topRow">
                ...
                <p className={classes.cross} test-handle="cross" onClick={props.handleClickCross}>x</p>
            ...
            <div className={classes.bottomRow} test-handle="bottomRow">
                ...
                <p className={classes.edit} test-handle="edit" onClick={props.handleClickEdit}>EDIT</p>
                <p className={classes.finish} test-handle="seen" onClick={props.handleClickSeen}>SEEN</p>
